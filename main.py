...
def get_dataset(dataset_type: str, dataset_name: str, fold_idx: int):
    if dataset_type == DatasetType.NODE_HOMO:
        datamodule = PlanetoidDataset(PlanetoidDatasetType[dataset_name])
        ...
        datamodule = GraphHomoDataset(GraphHomoDatasetType[dataset_name])
    return datamodule
...
def main(
    ...
    datamodule = get_dataset(dataset_type, dataset_name, fold_idx)
    model = GCN(
